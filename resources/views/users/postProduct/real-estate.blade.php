            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link text-danger" data-toggle="tab" href="#home">Real Estate</a>
                        </li>
                    </ul>
                    <div id="mytabContent" class="tab-content">
                        <div id="home">
                            <h1 id="selcatmsg" style="padding: 10px 10px;"></h1>
                            <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url('/postRealEstate') }}" style="padding-left: 20px;">
                                {{ csrf_field() }}
